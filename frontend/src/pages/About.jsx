...
Through empathy and innovation, we guide students to reach their fullest potential.
      ...
      <div className="flex flex-col md:flex-row mb-20">
        <div className='border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-teal-600 text-gray-600 duration-300 transition-all cursor-pointer hover:text-white'>
         <b>Efficiency</b>

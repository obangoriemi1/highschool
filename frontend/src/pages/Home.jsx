...
const Home = () => {
  return (
<div>
<div className="flex flex-col md:flex-row flex-wrap dark:bg-lime-100 bg-lime-50 rounded-lg px-6 md:px-10 lg:px-20">
    {/* left side */}
    <div className="md:w-1/2 flex  flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]"> 
      ...
      <div className='flex flex-col md:flex-row items-center gap-3 text-sm font-light'>
        ...
        <p className='dark:text-black'>Simply browse through our extensive list of courses,<b className='hidden sm:block'r/> tought by experience instructors</p>
